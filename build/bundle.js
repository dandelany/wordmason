...
/***/ function(module, exports, __webpack_require__) {
	...
	var App = function (_React$Component) {
	    ...
	    _createClass(App, [{
	        ...
	        value: function render() {
	            ...
	            var size = 14;
	            var testText = "Hi, how are you?";
	
	            var font = new Font();
	            font.fontFamily = family;
	            font.src = font.fontFamily;
	            var metrics = font.measureText(testText, size);
	            console.log(metrics);
	
	            var style = { fontFamily: family, fontSize: size + 'pt' };
	...
	setTimeout(function () {
	    var f = new window.Font();
	    f.fontFamily = "Helvetica Neue";
	    var x = new Date();
	    f.onload = function () {
	        console.log('loaded in ' + (new Date() - x) + ' ms');
	        console.log('async measure:', f.measureText('ok', 12));
	    };
	    f.src = f.fontFamily;
	    console.log('synchronous measure:', f.measureText('ok', 12));
	}, 1000);
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".graticule {\n  fill: none;\n  stroke: #777;\n}\n.boundary {\n  fill: #ccc;\n  fill-opacity: .8;\n  stroke: #000;\n}\n", ""]);
